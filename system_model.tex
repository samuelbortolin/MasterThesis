...
% TODO this section makes sense?

\section{System's common components}
\label{sec:components}
\vspace{0.2 cm}

% TODO in case the following modules should be described in detail?

Describe in detail the system's common components between the various specific use cases:
\begin{itemize}
  \item Authentication layer: manages the authentication process and permissions of users ... ;
  \item API layer: manages the user interactions with the system ... ;
  \item Task manager: coordinates the execution of the tasks ... ;
...
% TODO describe specialization of what written in the architecture section
