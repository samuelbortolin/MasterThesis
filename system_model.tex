...
For data loading task:
\begin{itemize}
  \item Data parser: ... ;
  \item Data storage: ... .
\end{itemize}

Describe the system's common components blocks across the various specific use cases:
\begin{itemize}
  \item Data preprocessing: (with also the data enrichment) ... ;
  \item Models training module: ... . Described more in detail in the specific use cases sections;
  \item Prediction module: ... . Described more in detail in the specific use cases sections.
\end{itemize}
