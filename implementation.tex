...
The auto\_arima method is used to automatically discover the optimal order for the SARIMA model to better fit the training active incomings and in case of the hourly granularity this is done for each hour using the week as the period for seasonal differencing.
