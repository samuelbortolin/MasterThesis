...
The thesis addressed the problems of forecasting customers' electricity demand based on past aggregated consumption data, PV plants' production based on past aggregated production data, and consumption baselines of individual customers based on past consumption data.
