...
Customers are able to securely download their own detailed energy usage in a standard format with a simple click.
They may choose to upload their own data to a third party applications or automate the secure transfer their own energy usage data to authorized third parties, based on affirmative (opt-in) customer consent and control.
