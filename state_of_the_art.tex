...
\cite{NAZIR2023100888} proposed a daily, weekly, and monthly energy consumption prediction model for single customer by using a Temporal Fusion Transformer (TFT).
