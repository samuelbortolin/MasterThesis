...
Services like UtilityAPI are compatible with the Green Button standard providing support for APIs (Application Programming Interfaces) and XML (Extensible Markup Language) schemas\footnote{ \url{https://utilityapi.com/docs/greenbutton} }.
