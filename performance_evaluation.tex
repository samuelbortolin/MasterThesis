...
Instead, the AutoML approach obtained a one-week MAPE of ... and a one-month MAPE of ...  % To be launched for more time (these are 2h with max 0.5 for each run)
...
Instead, the AutoML approach obtained a MAE percentage of 15.78.  % To be launched for more time (these are 2h with max 0.5 for each run)
...
Instead, the AutoML approach obtained a one-week MAPE of ... and a MAE of ... [kWh].  % To be launched for more time (these are 2h with max 0.5 for each run)
